  ...
  <div class="loginContainer">
    <el-form :rules="rules" ref="loginForm" :model="loginForm" >
      ...
      <el-form-item prop="code">
        验证码
        <el-input type="text" auto-complete="false" v-model="loginForm.code" placeholder="点击图片更换验证码" style="width: 160px; margin-right: 50px"></el-input>
...
export default {
  ...
  methods: {
    updateCaptcha () { // 点击验证码图片会更换验证码图片，跨域请求后端接口有关文件 vue.config.js
      this.getRequest('/captcha').then(res => {
        // console.log(res)
